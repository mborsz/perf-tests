...
func init() {
	...
	// Register indexer globally
	idxFunc := func(obj interface{}) ([]string, error) {
	...
	measurement.RegisterIndexer(corev1.SchemeGroupVersion.WithResource("pods"), cache.Indexers{"controllerUID": idxFunc})
}
